...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -690456371;
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::resizer::init_app())
                })())
            }
        },
    )
...
fn wire_resizer_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        ...
        move || {
            ...
            let api_percent = <u32>::sse_decode(&mut deserializer);
            deserializer.end();
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::resizer::resizer(
                        api_image,
                        api_width,
                        api_height,
                        api_percent,
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        1 => wire_resizer_impl(port, ptr, rust_vec_len, data_len),
        _ => unreachable!(),
    }
}
